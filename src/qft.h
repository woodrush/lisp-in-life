#ifndef QFTASM_RAMSTDIN_BUF_STARTPOSITION
    #define QFTASM_RAMSTDIN_BUF_STARTPOSITION 290
#endif
#ifndef QFTASM_STACK_SIZE
    #define QFTASM_STACK_SIZE 233
#endif
#define QFTASM_RAM_SIZE 1024
